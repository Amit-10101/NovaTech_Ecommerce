					...
					<div className={'grid grid-cols-2 gap-4 h-full'}>
						<div className="relative rounded-lg bg-[#262626] h-full overflow-hidden">
							...
							<div className="absolute bottom-0 left-0 bg-black bg-opacity-30 px-6 w-full p-4 text-white">
								...
								<button className="mt-4 px-4 py-2 bg-palette-red hover:bg-palette-darkRed text-white rounded">
									Shop Now
								</button>
							</div>
						</div>
...
const Home: React.FC = () => {
	return (
		<div className={'bg-palette-lightGray'}>
			...
			<div className="container mx-auto pb-14 grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
				<div className="p-4 py-10 rounded-md flex flex-col items-center">
					...
					<p className="text-gray-500">For orders over $50 within selected regions.</p>
				</div>
